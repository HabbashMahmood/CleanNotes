...
class NotesViewModel @Inject constructor(
    ...
    private var getTotalNotesCountJob: Job? = null
    ...
    private fun getTotalNotesCount() {
        getTotalNotesCountJob?.cancel()
        getTotalNotesCountJob = noteUseCases.getTotalNotesCount()
            .onEach {
                _state.value = state.value.copy(
                    totalNotesCount = it,
                )
